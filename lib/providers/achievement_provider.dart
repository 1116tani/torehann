...
final achievementListProvider = Provider.autoDispose<List<AchievementModel>>((ref) {
  ...
  return [
    ...
    AchievementModel(
      ...
      currentCount: (stats['loginDaysCount'] ?? 0).toDouble(), // 👈 日数用のキー
      copperValue: 3.0,
      silverValue: 15.0,
      goldValue: 50.0,
      unit: '日',
    ...
    AchievementModel(
      ...
      currentCount: (stats['treasureKindsCount'] ?? 0).toDouble(), // 👈 種類数用のキー
      copperValue: 1.0,
      silverValue: 6.0,
      goldValue: 12.0,
      unit: '種',
    ...
    AchievementModel(
      ...
      currentCount: (stats['fullyUnlockedFragmentsCount'] ?? 0).toDouble(), // 👈 全解放数用のキー
      copperValue: 1.0,
      silverValue: 3.0,
      goldValue: 6.0,
      unit: '種',
    ...
    AchievementModel(
      ...
      currentCount: (stats['photoPinCount'] ?? 0).toDouble(), // 👈 写真ピン用のキー
      copperValue: 1.0,
      silverValue: 5.0,
      goldValue: 10.0,
      unit: '枚',
