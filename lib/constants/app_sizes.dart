...
class AppSizes {
  ...
  static const double floatingButtonSize = 64.0;
  ...
  static const double mapButtonSize = 52.0;

  static const double compassSize = 88.0;

  static const double routeProgressHeight = 10.0;
